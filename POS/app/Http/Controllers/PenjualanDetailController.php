...
class PenjualanDetailController extends Controller
{
    public function index(){
        // DB::insert('insert into t_penjualan_detail(penjualan_id, barang_id, jumlah_barang, harga_barang, created_at) values(?, ?, ?, ?, ?)', [11, 11, 2, 120000, now()]);
        // return 'Insert data baru berhasil';

        // $row = DB::update('update t_penjualan_detail set jumlah_barang = ? where detail_id = ?', [3, 31]);
        ...
        // $row = DB::table('t_penjualan_detail')->where('detail_id', '31')->update(['jumlah_barang' => '3']);
        // return 'Update data berhasil, jumlah data yang diupdate: '.$row. ' baris';
